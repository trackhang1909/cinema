    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="row align-items-start navbar-nav ml-auto mr-auto">
            ...
            <li class="col nav-item dropdown" id="userDropdown">
                <a class="text-danger bg-light nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> TÀI KHOẢN </a>
                <div class="bg-light dropdown-menu" aria-labelledby="navbarDrop downMenuLink">
                    ...
                    <a class="bg-transparent text-danger dropdown-item" href="index.php">Thông tin cá nhân</a>
                    <a class="bg-transparent text-danger dropdown-item" id="logout" href="../login/logout.php">Đăng xuất</a>
                </div>
            </li>

            <!-- <li class="nav-item">
                <a class="nav-link text-danger" id="logout" href="login/logout.php">LOG OUT</a>
            </li> -->
