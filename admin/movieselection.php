...
<body>
    ...
    <div class="container">
        ...
        <tr class="control" style="text-align: left; font-weight: bold; font-size: 20px">
            <td>
                <a href="../film/formaddfilm.php" class="toHideAddFilm">Add Film</a>
                <a>|</a>
            </td>
            <td>
                <a href="../ticket/formaddticketinformation.php" id="toHideAddFilm">Add Ticket Information</a>
                <a>|</a>
            </td>
            <td>
                <a href="../admin/revenue.php" id="toHideAddFilm">Revenue</a>
            </td>
        </tr>
        <hr>
        <div id="movieselection-body">
            <div class="row card-deck">
                ...
                <?php
                    ...
                    $sql = "SELECT id, name, image, khoichieu, status FROM movieselection";
                ...
                <div class="col-4 card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="button ticket" type="button"><a href="../bookticket/bookticket.php?id=<?php echo $row["id"] ?>">Chỉnh sửa rạp</a></button>
                        <hr class="hrTag">
                        <a  href="../film/formeditfilm.php?id=<?php echo $row["id"] ?>">Edit Film</a> 
                        <a  href="../film/deletefilm.php?id=<?php echo $row["id"] ?>">Delete Film</a>
                    </div>
                    <div class="card-footer">
                        <small class="text-muted">Khởi chiếu: <?php echo $row["khoichieu"]?></small>
                        <br>
                        <small class="text-muted">Trạng thái: <?php echo $status?></small>
                    </div>
                </div>
